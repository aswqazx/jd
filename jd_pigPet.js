...
let shareId = "D99IAyFZLChler7KRIXm-Q"
$.shareCodes = [];
if ($.isNode()) {
...
!(async () => {
  ...
  let res2 = null //await getAuthorShareCode('https://raw.githubusercontent.com/Aaron-lv/updateTeam/master/shareCodes/pig.json')
  // if (!res2) {
