...
async function mr() {
  ...
  let client = new WebSocket(`wss://xinruimz-isv.isvjcloud.com/wss/?token=${$.token}`,null,{
    headers:{
      'user-agent': 'jdapp;iPhone;10.0.4;14.6;6188c5672d7b13705ae45e2cb5708577f631c729;network/wifi;model/iPhone12,1;addressid/1290361436;appBuild/167707;jdSupportDarkMode/0;Mozilla/5.0 (iPhone; CPU iPhone OS 14_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1',
    }
  })
  ...
  client.onmessage = async function (e) {
    if (e.data !== 'pong' && e.data && safeGet(e.data)) {
      let vo = JSON.parse(e.data);
      await $.wait(Math.random()*2000+5000);
...
function getToken() {
  let config = {
    ...
    headers: {
      ...
      'User-Agent': 'jdapp;iPhone;9.4.8;14.4.2;6188c5672d7b13705ae45e2cb5708577f631c729;network/wifi;supportApplePay/0;hasUPPay/0;hasOCPay/0;model/iPhone12,1;addressid/1290361436;supportBestPay/0;appBuild/167629;jdSupportDarkMode/0;Mozilla/5.0 (iPhone; CPU iPhone OS 14_4_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1',
